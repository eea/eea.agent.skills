...
react-native-skills skill. Currently, no overrides are needed as the upstream
guidelines are broadly applicable.

## Handoff to Other EEA Skills

When React Native tasks are complete, consider these EEA skills:

- **`eea-mobile-standards`** (future): EEA mobile app development standards
